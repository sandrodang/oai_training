...
| **N3** | T5 17/09 | Đọc **§1** *Illustrated Transformer* (1h) + nửa đầu *Annotated* (1,5h) · **BT 01** attention (1,5h) | 4h |
| **N4** | T6 18/09 | Nốt **§1** *Annotated* (1,5h) · nốt **BT 01** · **BT 02** transformer phần 1 (2,5h) | 4h |
| **N5** | T7 19/09 | **BT 02** transformer phần 2 🔴 (2,75h) · Đọc **§2** d2l attention + Bahdanau *mục 3* (1,25h) | 4h |
